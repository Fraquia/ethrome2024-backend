...
@router.post("/backend/compute_user_reputation")
def compute_user_reputation(sentence: str, wallet: str, farcaster_id: str):
    ...
    try:
        ...
        score = (text_prediction_score*identity_score)/2
